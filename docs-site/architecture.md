---
title: Architecture
description: How pkg packages Node.js applications into standalone executables — walker, bytecode fabricator, payload format, runtime bootstrap, SEA mode, and VFS provider.
---
