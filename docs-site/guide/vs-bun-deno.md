...
| `pkg . --sea --compress GZip`                                        | ✅ (same assets config)                                                                                                                              | **154 MB** | 980 ms            |
| `pkg . --sea --compress Zstd`                                        | ✅ (same assets config)                                                                                                                              | **152 MB** | 975 ms            |
| `pkg . --sea --compress Brotli`                                      | ✅ (same assets config, ~3 min build time)                                                                                                           | **147 MB** | 985 ms            |
