...
| `pkg . --sea` with `"pkg": {"assets": ["yoga.wasm","vendor/**/*"]}`  | ✅                                                                                                                                                   | **194 MB** | **610 ms**        |
| `pkg . --sea --compress GZip`                                        | ✅ (same assets config)                                                                                                                              | **154 MB** | 590 ms            |
| `pkg . --sea --compress Zstd`                                        | ✅ (same assets config)                                                                                                                              | **152 MB** | 560 ms            |
