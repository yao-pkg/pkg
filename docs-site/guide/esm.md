...
::: tip SEA mode
In [Enhanced SEA mode](/guide/sea-mode#enhanced-sea), ESM entry points with top-level await work on every supported target (Node >= 22) without the async-IIFE transform.
:::
