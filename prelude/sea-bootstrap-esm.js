...
// Node.js supports sea-config mainFormat:"module" (Node >= 25.7) AND the
// embedder dynamic-import callback resolves non-builtin modules (see
// nodejs/node#62726 — resolution is the gate for this bootstrap path).
//
